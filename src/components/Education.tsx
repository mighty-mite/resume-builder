export default function Education() {
  return (
    <li>
      <h2 className="text-lg font-bold capitalize">data scientist</h2>
      ...
      <ul className="experience__list">
        <li className="experience-responcibilities text-base font-semibold ml-5 text-left marker:text-contrast-color list-disc">
          Develop action plane to mitigate risks in decision making while
          increasing profitability by leveraging data science
        </li>
        <li className="experience-responcibilities text-base font-semibold ml-5 text-left">
